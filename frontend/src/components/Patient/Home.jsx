  ...
  return (
    <div className='bg-[#FEFAE0] '   >
        ...
        >
            ...
            className='flex flex-col items-center justify-center w-screen h-screen m-auto lg:flex-row max-w-7xl'>
                <motion.div
                ref={ref}
                initial={{ opacity: 0 }} 
...
>
                ...
                whileInView={{ opacity: 1 }}>
                            <div>
                                <div className='flex items-center justify-start gap-2 '>
                                    ...
                                    <div className='w-12 p-1 bg-white rounded-full'>
        ...
        whileInView={{ opacity: 1 }}
        >
            <div className='flex flex-col items-center justify-center h-full m-auto overflow-auto max-w-7xl'>
                <p className='pt-16 text-3xl font-semibold'>Meet Our Specialist</p>
        ...
        <section  
         ...
         >
            <div className='flex flex-col items-center justify-center w-full h-full gap-8 m-auto overflow-auto max-w-7xl'>
                <motion.div
                ref={ref}
                initial={{ opacity: 0 }} 
                animate={{ opacity: inView ? 1 : 0 }} 
        ...
        <section
         >
            <div className='absolute m-20 overflow-hidden lg:m-56 md:m-36 sm:m-24'>
                {/* newsletter */}
                <motion.div 
                ref={ref}
                initial={{ opacity: 0, x: -50 }} 
                ...
                transition={{ duration: 1.5 }}
                whileInView={{ opacity: 1 }}
                 className="z-10 px-2 py-10 mx-auto max-w-7xl lg:px-0 ">
            ...
            <div className='flex-col items-center justify-end hidden h-full m-auto lg:flex max-w-7xl'>
                <Footer/>
            </div>
        </section>
    </div>
